...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    } catch (error: any) { // Captura el error y cualquier mensaje asociado
      console.error('Error al iniciar sesión:', error);
      const errorMessage = error.response?.data?.message || 'Correo electrónico o contraseña incorrectos.';
